...
class CircleProgress: UIView {
    typealias progressChangedHandler = (progress: Double, circularView: CircleProgress) -> ()
    private var progressChangedClosure: progressChangedHandler?
    private var progressView: CircleShapeView!
    ...
    private func setup() {
        self.progressView = CircleShapeView(frame: self.bounds)
